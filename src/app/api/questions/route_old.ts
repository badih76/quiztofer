...
export async function GET(request: NextRequest) {    
    ...
    try {
        ...
        if(questionID != undefined) {
            get_exp_query += ` WHERE QST_ID = ${questionID}`;
        } else if(questionContain != undefined) {
            get_exp_query += ` WHERE QST_Question LIKE '%${questionContain}%'`;
        } else if(qstCategory != undefined) {
            get_exp_query += ` WHERE QST_Category = ${qstCategory}`;
        } else if(qstCatTitle != undefined) {
            get_exp_query += ` WHERE QST_Category = (SELECT CAT_ID FROM Categories WHERE CAT_Title = '${qstCatTitle}')`;
        }
